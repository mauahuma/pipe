...
export function ReportesMes() {
  ...
  const lunes = conveertDateQMonth("-", startOfWeek);
  const printRef = React.useRef();
  const dateMes = getCurrentDateMonth("-");
  ...
  const handleDownloadPdf = async () => {
    ...
    pdf.save(`Reporte mensual ${dateMes}.pdf`);
  };
...
export function getCurrentDateMonth(separator = "") {
...
export function conveertDateQMonth(separator = "", fecha) {
