...
export function ReportesSemana() {
  ...
  const lunes = conveertDateQSemana("-", startOfWeek);
  const printRef = React.useRef();
  const dateSemanal = getCurrentDateSemana("-");
  ...
  const handleDownloadPdf = async () => {
    ...
    pdf.save(`Reporte semanal ${dateSemanal}.pdf`);
  };
...
export function getCurrentDateSemana(separator = "") {
...
export function conveertDateQSemana(separator = "", fecha) {
